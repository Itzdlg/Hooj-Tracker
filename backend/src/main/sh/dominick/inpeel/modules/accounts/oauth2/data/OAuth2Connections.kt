package sh.dominick.inpeel.modules.accounts.oauth2.data
...
import sh.dominick.inpeel.modules.accounts.data.Account.Companion.referrersOn
...
import sh.dominick.inpeel.modules.accounts.oauth2.providers.OAuth2Grant
import sh.dominick.inpeel.modules.accounts.oauth2.providers.OAuth2Provider
...
val OAuth2Grant.connection
    get() = sh.dominick.inpeel.modules.accounts.oauth2.data.OAuth2Connection.find {
        sh.dominick.inpeel.modules.accounts.oauth2.data.OAuth2ConnectionsTable.providerAccountId eq providerAccountId
    }.firstOrNull()